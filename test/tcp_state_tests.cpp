    ...
    size_t payload_len = 0)
{
    ...
    if (payload && payload_len > 0) { std::memcpy(buf + ip_hdr_len + tcp_hdr_len, payload, payload_len); }
...
TEST_CASE("SYN state is determined correctly", "[tcp_conntrack]")
{
    ...
    uint8_t syn_buf[128];
    size_t syn_len = build_tcp_packet(syn_buf,
        client_ip,
        server_ip,
        client_port,
        server_port,
    ...
    uint8_t ack_buf[128];
    size_t ack_len = build_tcp_packet(ack_buf,
        client_ip,
        server_ip,
        client_port,
        server_port,
        /*seq=*/client_isn + 1,
        /*ack=*/server_isn_guess + 1,
        /*syn=*/false,
        /*ack_flag=*/true,
        /*fin=*/false,
        /*rst=*/false);
...
TEST_CASE("SYN-ACK state is determined correctly (server side)", "[tcp_conntrack]")
{
    ...
    size_t synack_len = build_tcp_packet(synack_buf,
        server_ip,
        client_ip,
        server_port,
        client_port,
        /*seq=*/server_isn,
        /*ack=*/client_isn_guess + 1,
        /*syn=*/true,
        /*ack_flag=*/true,
        /*fin=*/false,
        /*rst=*/false);
    ...
    size_t data_len = build_tcp_packet(data_buf,
        server_ip,
        client_ip,
        server_port,
        client_port,
...
TEST_CASE("FIN close sequence is determined correctly (client side)", "[tcp_conntrack]")
{
    ...
    uint8_t fin_buf[128];
    size_t fin_len = build_tcp_packet(fin_buf,
        client_ip,
        server_ip,
        client_port,
        server_port,
        /*seq=*/client_seq,
        /*ack=*/server_ack_guess,
        /*syn=*/false,
        /*ack_flag=*/true,
        /*fin=*/true,
        /*rst=*/false);
    ...
    size_t final_ack_len = build_tcp_packet(final_ack_buf,
        client_ip,
        server_ip,
        client_port,
        server_port,
        /*seq=*/client_seq + 1,
        /*ack=*/server_seq_guess + 1,
        /*syn=*/false,
        /*ack_flag=*/true,
        /*fin=*/false,
        /*rst=*/false);
...
TEST_CASE("RST immediately terminates the connection (client side)", "[tcp_conntrack]")
{
    ...
    uint8_t rst_buf[128];
    size_t rst_len = build_tcp_packet(rst_buf,
        client_ip,
        server_ip,
        client_port,
        server_port,
