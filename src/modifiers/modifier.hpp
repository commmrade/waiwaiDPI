...
public:
    ...
    [[nodiscard]] virtual bool matches(const int l4_proto, const L7Proto l7_proto) const = 0; // used to make sure that these packets can be processed by this modifier
};
