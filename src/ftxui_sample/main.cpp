...
// configuration step. It creates a namespace called `waiwaiDPI`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", waiwaiDPI::cmake::project_name, waiwaiDPI::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", waiwaiDPI::cmake::project_version);
      return EXIT_SUCCESS;
    }
