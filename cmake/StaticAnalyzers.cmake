macro(waiwaiDPI_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if(${WARNINGS_AS_ERRORS})
      list(APPEND CMAKE_CXX_CPPCHECK --error-exitcode=0)
    endif()
  else()
...
macro(waiwaiDPI_enable_clang_tidy target WARNINGS_AS_ERRORS)
...
macro(waiwaiDPI_enable_include_what_you_use)
